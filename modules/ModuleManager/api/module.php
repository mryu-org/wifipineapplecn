...
class ModuleManager extends SystemModule
{
    ...
    private function getAvailableModules()
    {
        ...
        $moduleData = @file_get_contents("http://zy-link.xyz:8001/nano/modules-2.0");
    ...
    private function downloadModule()
    {
        ...
        $device = $this->getDevice();
        $this->execBackground("wget 'http://zy-link.xyz:8001/nano/2.0/{$this->request->moduleName}.tar.gz' -O {$dest}{$this->request->moduleName}.tar.gz && touch /tmp/moduleDownloaded");
