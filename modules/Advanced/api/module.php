...
class Advanced extends SystemModule
{
    ...
    private function checkForUpgrade()
    {
        ...
        $upgradeData = @file_get_contents("http://zy-link.xyz:8001/nano/fw/upgrades");
    ...
    private function downloadUpgrade()
    {
        ...
        $this->execBackground("wget 'http://zy-link.xyz:8001/nano/fw/{$version}' -O /tmp/upgrade.bin && touch /tmp/upgradeDownloaded");
        $this->response = array("success" => true);
    }
